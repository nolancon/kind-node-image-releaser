...
build_kind_node() {
    ...
    kind build node-image --base-image kindest/base:$(docker images | grep "kindest/base" | head -1 | awk '{print $2}') --image "$KIND_NODE_IMAGE_REPO:$K8S_VERSION"
}
